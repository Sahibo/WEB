...
$(function() {
  ...
  function getGeolocation() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function(error) {
          console.log(error);
          var defaultLocation = 'New York, US';
  ...
  function getWeatherByCoordinates(latitude, longitude) {
    var appid = '4560a258fc38d956027b01e6e1de67ee';
    ...
    requestWeather.fail(function(jqXHR, textStatus, errorThrown) {
    ...
    requestForecast.done(function(data) {
      ...
      function doForecast(unit) {
        ...
        for (var i = 0; i < length; i++) {
          arr[i] = ("<div class='block'><h3 class='secondary'>" + forecast[i].date + 
          "</h3><h2 class='high'>" + forecast[i][unit].high + 
          "</h2><h4 class='secondary'>" + forecast[i][unit].low + 
          "</h4></div>");
        }
